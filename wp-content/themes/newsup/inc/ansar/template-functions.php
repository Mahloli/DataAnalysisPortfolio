...
if( ! function_exists( 'newsup_add_menu_description' ) ) :
    
    function newsup_add_menu_description( $item_output, $item, $depth, $args ) {
    ...
    add_filter( 'walker_nav_menu_start_el', 'newsup_add_menu_description', 10, 4 );
endif;
?>